...
long activationPeriod;
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(activationDate==null || ChronoUnit.SECONDS.between
				(activationDate, LocalDateTime.now())>activationPeriod)
			throw new UsernameNotFoundException("Either account doesn't exist or"
					+ " activation period has been exceeded");
		String [] roles=
		accountingManagement.getRoles(username).
		stream().map(r->"ROLE_"+r).toArray(String[]::new);
